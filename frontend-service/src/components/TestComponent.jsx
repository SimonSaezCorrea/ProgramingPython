    ...
    const mostrarAlertaFinalizar = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const test = {
                    user: userEntity[0].name,
                    time: formatTime(timer),
                    quest1_image: questEntity[0].image,
                    quest2_image: questEntity[1].image,
                    quest3_image: questEntity[2].image,
                    quest4_image: questEntity[3].image,
                    quest1_answer: questEntity[0].answer,
                    quest2_answer: questEntity[1].answer,
                    quest3_answer: questEntity[2].answer,
                    quest4_answer: questEntity[3].answer,
